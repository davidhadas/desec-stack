...
def test_zone_deletion(api_user_domain: DeSECAPIV1Client):
    name = api_user_domain.domains[0]
...
def test_signature_rotation_performance(api_user_domain: DeSECAPIV1Client):
    root_domain = api_user_domain.domains[0]

    # test configuration
    bulk_block_size = 1000
    domain_sizes = {
        # number of delegations: number of zones
        10000: 1,  # on my system, replication time about 20s
        1000: 2,   # on my system, replication time about 2s
    }
